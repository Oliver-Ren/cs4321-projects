...
/**
 * Class for a binary node in the tree representing a subtraction operation
 * 
 * @author Lucja Kot
 */

public class SubtractionTreeNode extends BinaryTreeNode {

	public SubtractionTreeNode(TreeNode left, TreeNode right) {
		super(left, right);
	}
